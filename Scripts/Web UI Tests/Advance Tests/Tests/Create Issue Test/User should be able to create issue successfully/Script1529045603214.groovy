...
def fixed_summary = WebUI.callTestCase(findTestCase('Web UI Tests/Advance Tests/Pages/Create Issue Page/Create a new issue with these information'), [('project') : project
        , ('issueType') : issueType, ('priority') : priority, ('description') : description, ('summary') : summary], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Web UI Tests/Advance Tests/Pages/Issue Page/The opening issue displays correct information'), [('issue_summary') : fixed_summary
