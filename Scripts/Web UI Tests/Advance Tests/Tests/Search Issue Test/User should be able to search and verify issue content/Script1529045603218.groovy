...
WebUI.callTestCase(findTestCase('Web UI Tests/Advance Tests/Tests/Search Issue Test/User should be able to search issues with an jql'), 
    [('issue_summary') : issue_summary], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Web UI Tests/Advance Tests/Pages/Search Issue Page/Simple Issue List/Open the issue having specified summary'), 
    [('issue_summary') : issue_summary], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Web UI Tests/Advance Tests/Pages/Issue Page/The opening issue displays correct information'), [('issue_summary') : issue_summary
