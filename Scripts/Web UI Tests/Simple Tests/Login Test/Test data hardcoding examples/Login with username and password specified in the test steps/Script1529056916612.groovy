...
WebUI.setText(findTestObject('web ui/Test Objects/Pages/Login Page/elUsername'), 'demo@katalon.com')

WebUI.click(findTestObject('web ui/Test Objects/Pages/Login Page/elContinue'))

WebUI.setText(findTestObject('web ui/Test Objects/Pages/Login Page/elEmail'), 'demo@katalon.com')
