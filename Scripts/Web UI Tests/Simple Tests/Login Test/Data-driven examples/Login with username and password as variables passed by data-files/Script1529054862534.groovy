...
WebUI.setText(findTestObject('web ui/Test Objects/Pages/Login Page/elEmail'), username)

WebUI.click(findTestObject('web ui/Test Objects/Pages/Login Page/elNext'))

WebUI.setText(findTestObject('web ui/Test Objects/Pages/Login Page/elPassword'), password)
